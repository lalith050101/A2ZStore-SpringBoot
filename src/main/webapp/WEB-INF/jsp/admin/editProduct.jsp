		...
		<%@ taglib prefix="t" tagdir="/WEB-INF/tags" %>
			...
			<t:adminLayout>
				...
				<div class="container p-2">
					<form:form action="/editProduct/${productModel.productId}" method="post"
						...
						<div class="form-group row ml-5">
							...
							<div class="col-md-6">
								<form:textarea minlength="5" maxlength="250" rows="5" cols="40" path="description"
									class="form-control" id="validationDeafult03" />
							</div>
						</div>
						...
						<div class="form-group row ml-5">
							...
							<div class="col-md-6">
								<form:input class="form-control" type="text" path="category" minlength="3"
									maxlength="30" id="validationDeafult05" />
							</div>
						</div>
						...
						<div class="form-group row ml-5">
							...
							<div class="col-md-6">
								<form:textarea path="imageUrl" minlength="5" maxlength="300" rows="5" cols="40"
									class="form-control" id="validationDeafult06" />
							</div>
						</div>
